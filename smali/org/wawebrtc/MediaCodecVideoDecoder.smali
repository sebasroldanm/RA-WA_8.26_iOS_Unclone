...
.field public static errorCallback:LX/2wv;
...
.field public textureListener:LX/3Ia;
...
.method private dequeueOutputBuffer(I)Lorg/wawebrtc/MediaCodecVideoDecoder$BufferInfo;
    ...
    iget-wide v12, v0, LX/2ws;->A03:J

    iget-wide v14, v0, LX/2ws;->A02:J

    iget v2, v0, LX/2ws;->A00:I
    ...
    invoke-static {v3, v0, v5}, LX/1sC;->A05(Landroid/media/MediaFormat;Ljava/lang/String;LX/0xo;)LX/0xk;

    move-result-object v8

    iget v3, v8, LX/0xk;->A09:I

    iput v3, v1, Lorg/wawebrtc/MediaCodecVideoDecoder;->width:I

    iget v2, v8, LX/0xk;->A06:I

    iput v2, v1, Lorg/wawebrtc/MediaCodecVideoDecoder;->height:I

    iget v0, v8, LX/0xk;->A08:I
    ...
    invoke-static {v0, v2}, LX/0CI;->A0w(Ljava/lang/StringBuilder;I)V

    :cond_2
    iget v3, v8, LX/0xk;->A01:I

    if-ltz v3, :cond_0

    iget v2, v8, LX/0xk;->A07:I

    if-ge v3, v2, :cond_0

    iget v0, v8, LX/0xk;->A04:I
    ...
    invoke-static {v0, v3}, LX/0CI;->A0w(Ljava/lang/StringBuilder;I)V
...
.method public static findDecoder(Ljava/lang/String;[Ljava/lang/String;IZ)Ljava/util/List;
    ...
    invoke-static {v2, v0}, LX/0CI;->A0n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3}, LX/1sC;->A0E(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v3, v0}, LX/1sC;->A0E(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-static {v2, v0, v1}, LX/0CI;->A0Q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v2, v14}, LX/0CI;->A0E(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v9}, LX/1sC;->A0F(Ljava/lang/String;I)[I
    ...
    invoke-static/range {v19 .. v21}, LX/0CI;->A0Q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct/range {v19 .. v22}, LX/2wu;-><init>(Ljava/lang/String;ILandroid/media/MediaCodecInfo$CodecCapabilities;)V
...
.method private initDecode(LX/2ww;IILX/2x5;[B[B)Z
    .locals 10
    ...
    :cond_2
    sget-object v0, LX/2ww;->A04:LX/2ww;
    ...
    iget-object v0, v1, LX/2wu;->A02:Ljava/lang/String;
    ...
    invoke-static {v5, v0, v6}, LX/1sC;->A05(Landroid/media/MediaFormat;Ljava/lang/String;LX/0xo;)LX/0xk;

    move-result-object v0

    iget v4, v0, LX/0xk;->A00:I

    iput v4, p0, Lorg/wawebrtc/MediaCodecVideoDecoder;->colorFormat:I

    iget v0, v0, LX/0xk;->A05:I
    ...
    invoke-direct {p0, v1}, Lorg/wawebrtc/MediaCodecVideoDecoder;->setDecoderFlags(LX/2wu;)V
...
.method private initH264Decoder(II[B[B)Z
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, v3}, Lorg/wawebrtc/MediaCodecVideoDecoder;->setDecoderFlags(LX/2wu;)V

    sget-object v1, LX/2ww;->A01:LX/2ww;
    ...
    invoke-direct/range {v0 .. v6}, Lorg/wawebrtc/MediaCodecVideoDecoder;->initDecode(LX/2ww;IILX/2x5;[B[B)Z
...
.method private initH265Decoder(II[B[B)Z
    ...
    sget-object v1, LX/2ww;->A02:LX/2ww;
...
.method private queueInputBuffer(IIJJI)Z
    ...
    invoke-direct/range {v3 .. v10}, LX/2ws;-><init>(JJJI)V
    ...
    iput-wide v4, v3, LX/2ws;->A01:J

    iput-wide v6, v3, LX/2ws;->A03:J

    iput-wide v8, v3, LX/2ws;->A02:J

    iput v10, v3, LX/2ws;->A00:I
...
.method private release()V
    ...
    invoke-direct {v1, p0, v3}, LX/2wq;-><init>(Lorg/wawebrtc/MediaCodecVideoDecoder;Ljava/util/concurrent/CountDownLatch;)V
...
.method private setDecoderFlags(LX/2wu;)V
    .locals 8
    ...
    iget-object v1, p1, LX/2wu;->A02:Ljava/lang/String;
    ...
    iget-object v1, p1, LX/2wu;->A01:Landroid/media/MediaCodecInfo$CodecCapabilities;
    ...
    invoke-static {v1, v0, v2}, LX/1TD;->A04(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static setErrorCallback(LX/2wv;)V
    .locals 0
