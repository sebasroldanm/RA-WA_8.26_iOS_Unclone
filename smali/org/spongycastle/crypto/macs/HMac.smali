...
.field public digest:LX/1TF;

.field public digestSize:I

.field public inputPad:[B

.field public ipadState:LX/1TG;

.field public opadState:LX/1TG;
...
.method public constructor <init>(LX/1TF;)V
    ...
    invoke-static {p1}, Lorg/spongycastle/crypto/macs/HMac;->getByteLength(LX/1TF;)I

    move-result v0

    invoke-direct {p0, p1, v0}, Lorg/spongycastle/crypto/macs/HMac;-><init>(LX/1TF;I)V

    return-void
.end method

.method public constructor <init>(LX/1TF;I)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/spongycastle/crypto/macs/HMac;->digest:LX/1TF;

    invoke-interface {p1}, LX/1TF;->A51()I
...
.method public static getByteLength(LX/1TF;)I
    .locals 3
    ...
    invoke-interface {p0}, LX/27n;->A4K()I
    ...
    invoke-interface {p0}, LX/1TF;->A44()Ljava/lang/String;
...
.method public doFinal([BI)I
    ...
    iget-object v2, p0, Lorg/spongycastle/crypto/macs/HMac;->digest:LX/1TF;
    ...
    iget-object v1, p0, Lorg/spongycastle/crypto/macs/HMac;->opadState:LX/1TG;

    const/4 v4, 0x0

    if-eqz v1, :cond_0

    iget-object v0, p0, Lorg/spongycastle/crypto/macs/HMac;->digest:LX/1TF;

    check-cast v0, LX/1TG;

    invoke-interface {v0, v1}, LX/1TG;->AIW(LX/1TG;)V

    iget-object v3, p0, Lorg/spongycastle/crypto/macs/HMac;->digest:LX/1TF;
    ...
    invoke-interface {v3}, LX/1TF;->A51()I

    move-result v0

    invoke-interface {v3, v2, v1, v0}, LX/1TF;->update([BII)V

    :goto_0
    iget-object v0, p0, Lorg/spongycastle/crypto/macs/HMac;->digest:LX/1TF;

    invoke-interface {v0, p1, p2}, LX/1TF;->doFinal([BI)I
    ...
    invoke-interface {v2, v1, v4, v0}, LX/1TF;->update([BII)V

    goto :goto_0

    :cond_1
    iget-object v1, p0, Lorg/spongycastle/crypto/macs/HMac;->ipadState:LX/1TG;
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    invoke-interface {v0}, LX/1TF;->A44()Ljava/lang/String;
...
.method public getUnderlyingDigest()LX/1TF;
    .locals 1
...
.method public init(LX/2w3;)V
    ...
    iget-object v2, p1, LX/3I5;->A00:[B
    ...
    iget-object v1, p0, Lorg/spongycastle/crypto/macs/HMac;->digest:LX/1TF;

    invoke-interface {v1, v2, v3, v4}, LX/1TF;->update([BII)V

    iget-object v0, p0, Lorg/spongycastle/crypto/macs/HMac;->inputPad:[B

    invoke-interface {v1, v0, v3}, LX/1TF;->doFinal([BI)I
    ...
    invoke-interface {v1}, LX/1TG;->A2w()LX/1TG;

    move-result-object v2

    iput-object v2, p0, Lorg/spongycastle/crypto/macs/HMac;->opadState:LX/1TG;
    ...
    invoke-interface {v2, v1, v3, v0}, LX/1TF;->update([BII)V
    ...
    instance-of v0, v2, LX/1TG;

    if-eqz v0, :cond_3

    check-cast v2, LX/1TG;

    invoke-interface {v2}, LX/1TG;->A2w()LX/1TG;

    move-result-object v0

    iput-object v0, p0, Lorg/spongycastle/crypto/macs/HMac;->ipadState:LX/1TG;
...
.method public reset()V
    ...
    invoke-interface {v3, v2, v0, v1}, LX/1TF;->update([BII)V
