...
.method public static createFromRawInfo(LX/2tx;)Lorg/pjsip/PjCameraInfo;
    .locals 13
    ...
    iget-object v1, p0, LX/2tx;->A05:[I
    ...
    invoke-static {v2}, Lorg/pjsip/PjCameraInfo;->getEncoderSupportedColorFormats(LX/1Sl;)[I
    ...
    :cond_2
    iget-boolean v7, p0, LX/2tx;->A04:Z

    iget-object v0, p0, LX/2tx;->A03:Ljava/util/List;
    ...
    :cond_3
    iget-object v1, v2, LX/1Sl;->A00:Landroid/content/SharedPreferences;
    ...
    :cond_8
    iget-object v10, p0, LX/2tx;->A02:LX/2ty;

    if-eqz v10, :cond_9

    iget v1, v10, LX/2ty;->A00:I

    iget v0, v10, LX/2ty;->A01:I
...
.method public static getCameraInfo(I)Lorg/pjsip/PjCameraInfo;
    ...
    invoke-virtual {v2, p0}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->getRawCameraInfo(I)LX/2tx;
    ...
    :cond_0
    invoke-static {v0}, Lorg/pjsip/PjCameraInfo;->createFromRawInfo(LX/2tx;)Lorg/pjsip/PjCameraInfo;
...
.method public static getEncoderSupportedColorFormats(LX/1Sl;)[I
    .locals 4

    iget-object v2, p0, LX/1Sl;->A00:Landroid/content/SharedPreferences;
...
.method public static synthetic lambda$static$0(LX/2ty;LX/2ty;)I
    .locals 2

    iget v1, p0, LX/2ty;->A01:I

    iget v0, p1, LX/2ty;->A01:I
