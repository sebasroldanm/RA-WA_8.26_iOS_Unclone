...
# direct methods
.method public static A00(LX/0qj;LX/17O;Ljava/io/File;)V
    .locals 5
    ...
    :try_start_0
    invoke-static {p2, v4}, LX/2pC;->A06(Ljava/io/File;Z)LX/2p2;

    move-result-object v0

    iget v0, v0, LX/2p2;->A00:I

    if-eqz v0, :cond_1

    invoke-virtual {p1, p2}, LX/17O;->A07(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p1, v3, p2}, LX/2p8;->A0f(LX/17O;Ljava/io/File;Ljava/io/File;)Z
    ...
    invoke-direct {v3, v4, p0}, LX/0uO;-><init>(ILjava/lang/String;)V
...
.method public static A01(Ljava/io/File;Ljava/io/File;Ljava/io/File;Ljava/io/File;IJJJ)V
    .locals 9
    ...
    invoke-static/range {v0 .. v8}, Lcom/whatsapp/Mp4Ops;->mp4mux(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;FFFFILjava/lang/String;)Lcom/whatsapp/Mp4Ops$LibMp4OperationResult;
    :try_end_0
