...
.method public static A00()Landroid/os/Handler;
    ...
    sget-object v0, Lcom/whatsapp/appwidget/WidgetProvider;->A01:Landroid/os/Handler;
    ...
    sput-object v1, Lcom/whatsapp/appwidget/WidgetProvider;->A01:Landroid/os/Handler;
...
.method public static A01(Landroid/content/Context;LX/0nc;LX/181;III)Landroid/widget/RemoteViews;
    .locals 10

    invoke-virtual {p1}, LX/0nc;->A05()Z
    ...
    sget-object v0, Lcom/whatsapp/appwidget/WidgetProvider;->A03:Ljava/util/ArrayList;
    ...
    invoke-static {v0}, Lcom/whatsapp/yo/WidgetProvider;->setNC(I)V
    ...
    sget-object v2, Lcom/whatsapp/appwidget/WidgetProvider;->A03:Ljava/util/ArrayList;
    ...
    invoke-virtual {p2, v8, v0, v1, v6}, LX/181;->A09(IJ[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v3, p3, v6, v1}, Landroid/widget/RemoteViews;->setRemoteAdapter(IILandroid/content/Intent;)V
    ...
    invoke-static {v1}, Lcom/whatsapp/yo/yo;->notifIn(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {v3, v6, v0}, Landroid/widget/RemoteViews;->setPendingIntentTemplate(ILandroid/app/PendingIntent;)V
    ...
    invoke-virtual {v3, v6, v2}, Landroid/widget/RemoteViews;->setEmptyView(II)V

    invoke-virtual {p1}, LX/0nc;->A08()Z
...
.method public static A02(Landroid/content/Context;)V
    ...
    :cond_0
    invoke-static {p0}, LX/2Ww;->A00(Landroid/content/Context;)LX/2Ww;
    ...
    sget-object v0, Lcom/whatsapp/appwidget/WidgetProvider;->A02:Ljava/lang/Runnable;

    if-nez v0, :cond_3

    new-instance v0, LX/0z9;

    invoke-direct {v0, v2}, LX/0z9;-><init>(LX/2Ww;)V

    sput-object v0, Lcom/whatsapp/appwidget/WidgetProvider;->A02:Ljava/lang/Runnable;
...
.method public onAppWidgetOptionsChanged(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;ILandroid/os/Bundle;)V
    ...
    invoke-static {v1, v4, v0, v5}, LX/0CI;->A0f(Ljava/lang/String;ILjava/lang/String;I)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/whatsapp/appwidget/WidgetProvider;->A01(Landroid/content/Context;LX/0nc;LX/181;III)Landroid/widget/RemoteViews;
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    iget-object v0, p0, Lcom/whatsapp/appwidget/WidgetProvider;->A00:LX/0zA;

    if-eqz v0, :cond_0

    iget-object v1, v0, LX/0zA;->A08:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p1, p2, p3}, LX/0zA;-><init>(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V

    iput-object v0, p0, Lcom/whatsapp/appwidget/WidgetProvider;->A00:LX/0zA;
    ...
    invoke-static {p1}, Lcom/whatsapp/yo/WidgetProvider;->updateYoWAWidget(Landroid/content/Context;)V
