...
# instance fields
.field public cameraEventsListener:LX/2u2;
...
# direct methods
.method public constructor <init>(LX/17X;LX/1Sl;)V
    .locals 1
    ...
    invoke-direct {v0, p0}, LX/3L0;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCameraManager;)V

    iput-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->cameraEventsListener:LX/2u2;

    iput-object p1, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->waContext:LX/17X;

    iput-object p2, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->voipSharedPreferences:LX/1Sl;
...
.method public static clearStoredRawCameraInfo(Lcom/whatsapp/voipcalling/camera/VoipCameraManager;II)V
    ...
    iget-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->voipSharedPreferences:LX/1Sl;
    ...
    invoke-static {p1, p2}, LX/1Sl;->A01(II)Ljava/lang/String;
...
.method public static declared-synchronized closeCurrentCamera(Lcom/whatsapp/voipcalling/camera/VoipCameraManager;Lcom/whatsapp/voipcalling/camera/VoipCamera;)V
    ...
    iget-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->cameraEventsListener:LX/2u2;

    invoke-virtual {v2, v0}, Lcom/whatsapp/voipcalling/camera/VoipCamera;->removeCameraEventsListener(LX/2u2;)V
    ...
    invoke-virtual {p1, v0}, Lcom/whatsapp/voipcalling/camera/VoipCamera;->removeCameraEventsListener(LX/2u2;)V
...
.method public static getInstance()Lcom/whatsapp/voipcalling/camera/VoipCameraManager;
    ...
    invoke-direct {v2, v1, v0}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;-><init>(LX/17X;LX/1Sl;)V
...
.method private isRawCameraInfoValid(ILX/2tx;)Z
    .locals 6

    iget v1, p2, LX/2tx;->A00:I
    ...
    :try_start_1
    iget-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->waContext:LX/17X;
    ...
    iget-boolean v2, p2, LX/2tx;->A04:Z
...
.method private loadFromCameraService(I)LX/2tx;
    .locals 18
    ...
    iget-object v0, v3, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->waContext:LX/17X;
    ...
    :cond_5
    invoke-virtual {v8}, Landroid/hardware/camera2/params/StreamConfigurationMap;->getOutputFormats()[I
    ...
    invoke-static {v11, v7, v0}, LX/0CI;->A0L(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {v3, v2, v0}, LX/2ty;-><init>(II)V
    ...
    :cond_e
    invoke-virtual {v8}, Landroid/hardware/Camera$Parameters;->getPreferredPreviewSizeForVideo()Landroid/hardware/Camera$Size;
    ...
    invoke-direct/range {v11 .. v17}, LX/2tx;-><init>(IZI[ILX/2ty;Ljava/util/List;)V
    ...
    invoke-direct {v6, v1, v0}, LX/2ty;-><init>(II)V
...
# virtual methods
.method public addCameraErrorListener(LX/2u2;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/whatsapp/voipcalling/camera/VoipCamera;->addCameraEventsListener(LX/2u2;)V
...
.method public declared-synchronized createCamera(IIIIIJ)Lcom/whatsapp/voipcalling/camera/VoipCamera;
    ...
    invoke-virtual {p0, p1}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->getRawCameraInfo(I)LX/2tx;

    move-result-object v0

    if-eqz v0, :cond_3

    iget v0, v0, LX/2tx;->A00:I
    ...
    invoke-direct/range {v4 .. v11}, LX/3HC;-><init>(IIIIIJ)V
    :try_end_3
    ...
    invoke-virtual {v4, v0}, Lcom/whatsapp/voipcalling/camera/VoipCamera;->addCameraEventsListener(LX/2u2;)V
...
.method public getCachedCam2HardwareLevel()I
    ...
    :goto_0
    iget-object v1, p0, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->voipSharedPreferences:LX/1Sl;

    iget-object v1, v1, LX/1Sl;->A00:Landroid/content/SharedPreferences;
    ...
    invoke-static {v1, v0}, LX/0CI;->A0c(Ljava/lang/String;I)V

    return v0

    :cond_1
    sget-object v0, LX/3HC;->A0F:[I
...
.method public getLastCachedFrame()LX/2u4;
    ...
    invoke-virtual {v0}, Lcom/whatsapp/voipcalling/camera/VoipCamera;->getLastCachedFrame()LX/2u4;
...
.method public declared-synchronized getRawCameraInfo(I)LX/2tx;
    .locals 18
    ...
    iget-object v1, v3, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->voipSharedPreferences:LX/1Sl;

    iget v0, v3, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->currentApiVersion:I

    iget-object v1, v1, LX/1Sl;->A00:Landroid/content/SharedPreferences;

    invoke-static {v4, v0}, LX/1Sl;->A01(II)Ljava/lang/String;
    ...
    invoke-direct {v9, v1, v0}, LX/2ty;-><init>(II)V
    ...
    invoke-direct {v2, v1, v0}, LX/2ty;-><init>(II)V
    ...
    invoke-direct {v3, v4, v11}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->isRawCameraInfoValid(ILX/2tx;)Z
    ...
    invoke-direct {v3, v4}, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->loadFromCameraService(I)LX/2tx;
    ...
    iget-object v6, v11, LX/2tx;->A05:[I
    ...
    iget-object v0, v11, LX/2tx;->A02:LX/2ty;
    ...
    iget-object v1, v11, LX/2tx;->A02:LX/2ty;

    iget v0, v1, LX/2ty;->A01:I

    invoke-virtual {v2, v0}, Lorg/json/JSONArray;->put(I)Lorg/json/JSONArray;

    iget v0, v1, LX/2ty;->A00:I
    ...
    iget-object v0, v11, LX/2tx;->A03:Ljava/util/List;
    ...
    iget-object v0, v3, Lcom/whatsapp/voipcalling/camera/VoipCameraManager;->voipSharedPreferences:LX/1Sl;

    iget v2, v11, LX/2tx;->A00:I
    ...
    invoke-static {v4, v2}, LX/1Sl;->A01(II)Ljava/lang/String;
...
.method public removeCameraErrorListener(LX/2u2;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/whatsapp/voipcalling/camera/VoipCamera;->removeCameraEventsListener(LX/2u2;)V
