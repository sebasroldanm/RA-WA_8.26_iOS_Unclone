...
.field public final cameraEventsDispatcher:LX/2u1;
...
.field public textureHolder:LX/2tE;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, LX/2u1;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;)V

    iput-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipCamera;->cameraEventsDispatcher:LX/2u1;

    new-instance v1, LX/2tz;

    const-string v0, "VoipCameraThread"

    invoke-direct {v1, v0}, LX/2tz;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, v0}, LX/2u0;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;Landroid/os/Looper;)V
...
# virtual methods
.method public final addCameraEventsListener(LX/2u2;)V
    .locals 2

    iget-object v1, p0, Lcom/whatsapp/voipcalling/camera/VoipCamera;->cameraEventsDispatcher:LX/2u1;

    monitor-enter v1

    :try_start_0
    iget-object v0, v1, LX/2u1;->A00:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final declared-synchronized close()V
    ...
    invoke-direct {v1, p0}, LX/2tv;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;)V
...
.method public createTexture()V
    ...
    invoke-interface {v0}, Lcom/whatsapp/voipcalling/VideoPort;->createSurfaceTexture()LX/2tE;

    move-result-object v0

    iput-object v0, p0, Lcom/whatsapp/voipcalling/camera/VoipCamera;->textureHolder:LX/2tE;
    ...
    :cond_2
    iget-object v1, v0, LX/2tE;->A01:Landroid/graphics/SurfaceTexture;

    new-instance v0, LX/2ts;

    invoke-direct {v0, p0}, LX/2ts;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;)V
...
.method public abstract getLastCachedFrame()LX/2u4;
.end method
...
.method public releaseTexture()V
    ...
    invoke-interface {v1, v0}, Lcom/whatsapp/voipcalling/VideoPort;->releaseSurfaceTexture(LX/2tE;)V

    iput-object v2, p0, Lcom/whatsapp/voipcalling/camera/VoipCamera;->textureHolder:LX/2tE;

    :cond_1
    return-void
.end method

.method public final removeCameraEventsListener(LX/2u2;)V
    .locals 2
...
.method public final declared-synchronized setVideoPort(Lcom/whatsapp/voipcalling/VideoPort;)I
    ...
    invoke-direct {v1, p0, p1}, LX/2tt;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;Lcom/whatsapp/voipcalling/VideoPort;)V
...
.method public final declared-synchronized start()I
    ...
    invoke-direct {v1, p0}, LX/2tq;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;)V
...
.method public final declared-synchronized stop()V
    ...
    invoke-direct {v1, p0}, LX/2tw;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;)V
...
.method public final syncRunOnCameraThread(Ljava/util/concurrent/Callable;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, v2, p1}, LX/2tr;-><init>(Lcom/whatsapp/voipcalling/camera/VoipCamera;Ljava/util/concurrent/Exchanger;Ljava/util/concurrent/Callable;)V
