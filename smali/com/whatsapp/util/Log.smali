...
.field public static final LOGGER_THREAD:LX/1Rj;
...
.field public static final connectivityType:LX/27b;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v2, v1, v0}, LX/27b;-><init>(LX/1x6;Ljava/lang/String;)V

    sput-object v2, Lcom/whatsapp/util/Log;->connectivityType:LX/27b;
    ...
    sput-object v0, Lcom/whatsapp/util/Log;->LOGGER_THREAD:LX/1Rj;
...
.method public static adorn(Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/whatsapp/util/Log;->connectivityType:LX/27b;
...
.method public static compress()Ljava/io/File;
    ...
    invoke-static {v7, v1, v0}, LX/1Ha;->A0C(Ljava/io/File;Ljava/util/Date;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v4, v0}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V
    :try_end_2
    ...
    :try_start_5
    invoke-static {v8, v6, v13}, Lcom/whatsapp/util/Log;->appendStream(Ljava/util/zip/GZIPOutputStream;Ljava/io/BufferedInputStream;[B)V
    :try_end_5
...
.method public static flush()V
    ...
    sget-object v3, Lcom/whatsapp/util/Log;->LOGGER_THREAD:LX/1Rj;
    ...
    iget-object v0, v3, LX/1Rj;->A02:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-virtual {v3}, LX/1Rj;->A00()V
...
.method public static initialize()Z
    ...
    invoke-direct {v1, v0}, LX/1Rk;-><init>(Ljava/io/OutputStream;)V
    ...
    invoke-direct {v2, v1, v0}, LX/1Rl;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
...
.method public static logAdorned(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object v0, Lcom/whatsapp/util/Log;->LOGGER_THREAD:LX/1Rj;
    ...
    :cond_0
    invoke-virtual {v0, p0}, LX/1Rj;->A01(Ljava/lang/Object;)V
