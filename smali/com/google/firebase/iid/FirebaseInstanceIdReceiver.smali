...
.method public static A00(Landroid/content/BroadcastReceiver;Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)V
    ...
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A02:LX/0Vw;

    if-nez v0, :cond_3

    new-instance v0, LX/0Vw;

    invoke-direct {v0, p1, p2}, LX/0Vw;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A02:LX/0Vw;

    :cond_3
    sget-object v4, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A02:LX/0Vw;

    goto :goto_2

    :cond_4
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A01:LX/0Vw;
    ...
    sput-object v0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A01:LX/0Vw;

    :cond_5
    sget-object v4, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->A01:LX/0Vw;
    :try_end_0
    ...
    :cond_6
    iget-object v2, v4, LX/0Vw;->A04:Ljava/util/Queue;

    new-instance v1, LX/0Vs;

    iget-object v0, v4, LX/0Vw;->A05:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {v1, p3, v3, v0}, LX/0Vs;-><init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final A01(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    :cond_b
    iget-object v0, v4, LX/0Vj;->A03:Ljava/util/Queue;
    ...
    :cond_c
    iget-object v0, v4, LX/0Vj;->A04:Ljava/util/Queue;
    ...
    iget-object v3, v4, LX/0Vj;->A02:LX/04S;

    monitor-enter v3

    :try_start_0
    iget-object v1, v4, LX/0Vj;->A02:LX/04S;
    ...
    invoke-virtual {v1, v0, v7}, LX/04S;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_b
    :try_start_2
    invoke-virtual {v4, p1}, LX/0Vj;->A01(Landroid/content/Context;)Z
