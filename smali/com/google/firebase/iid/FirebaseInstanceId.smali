...
# static fields
.field public static A08:LX/0Vl;
...
.method public constructor <init>(LX/0VA;LX/0Vg;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;LX/0VR;LX/0WI;)V
    .locals 4
    ...
    invoke-static {p1}, LX/0Vg;->A00(LX/0VA;)Ljava/lang/String;
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/FirebaseInstanceId;->A08:LX/0Vl;
    ...
    invoke-direct {v1, v0}, LX/0Vl;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceId;->A08:LX/0Vl;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A02:LX/0VA;

    iput-object p2, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A04:LX/0Vg;

    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A00:LX/0VU;
    ...
    iget-object v0, p1, LX/0VA;->A03:LX/1f8;
    ...
    iput-object v1, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A00:LX/0VU;

    :cond_2
    :goto_0
    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A00:LX/0VU;

    iput-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A00:LX/0VU;
    ...
    invoke-direct {v1, v0}, LX/0Vp;-><init>(LX/0Vl;)V

    iput-object v1, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A06:LX/0Vp;

    new-instance v1, LX/0VS;

    invoke-direct {v1, p0, p5}, LX/0VS;-><init>(Lcom/google/firebase/iid/FirebaseInstanceId;LX/0VR;)V

    iput-object v1, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A03:LX/0VS;

    new-instance v0, LX/0Vh;

    invoke-direct {v0, p3}, LX/0Vh;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A05:LX/0Vh;
    ...
    invoke-direct {v0, p1, p2, p3, p6}, LX/1fR;-><init>(LX/0VA;LX/0Vg;Ljava/util/concurrent/Executor;LX/0WI;)V
...
.method public static A00(Ljava/lang/String;Ljava/lang/String;)LX/0Vk;
    .locals 5
    ...
    :try_start_0
    iget-object v1, v3, LX/0Vl;->A01:Landroid/content/SharedPreferences;

    invoke-static {v0, p0, p1}, LX/0Vl;->A01(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v2, v0, v1}, LX/0Vk;-><init>(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-direct {p1, v2, v4, v0, v1}, LX/0Vk;-><init>(Ljava/lang/String;Ljava/lang/String;J)V
...
.method public static A01()Ljava/lang/String;
    ...
    sget-object v2, Lcom/google/firebase/iid/FirebaseInstanceId;->A08:LX/0Vl;
    ...
    :try_start_0
    iget-object v0, v2, LX/0Vl;->A03:Ljava/util/Map;
    ...
    :try_start_1
    iget-object v7, v2, LX/0Vl;->A02:LX/0W6;

    iget-object v5, v2, LX/0Vl;->A00:Landroid/content/Context;

    const/4 v6, 0x0
    :try_end_1
    .catch LX/0W7; {:try_start_1 .. :try_end_1} :catch_4
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :try_start_2
    invoke-static {v5, v3}, LX/0W6;->A04(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    goto :goto_0
    :try_end_2
    .catch LX/0W7; {:try_start_2 .. :try_end_2} :catch_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    :cond_0
    :try_start_3
    invoke-static {v8}, LX/0W6;->A02(Ljava/io/File;)LX/0VW;
    ...
    goto :goto_1
    :try_end_3
    .catch LX/0W7; {:try_start_3 .. :try_end_3} :catch_0
    ...
    :try_end_4
    .catch LX/0W7; {:try_start_4 .. :try_end_4} :catch_2
    ...
    .catch LX/0W7; {:try_start_5 .. :try_end_5} :catch_2
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    :try_start_6
    invoke-static {v5, v3, v0}, LX/0W6;->A06(Landroid/content/Context;Ljava/lang/String;LX/0VW;)V
    ...
    invoke-direct {v0, v8}, LX/0W7;-><init>(Ljava/lang/Exception;)V

    throw v0
    :try_end_6
    .catch LX/0W7; {:try_start_6 .. :try_end_6} :catch_2
    ...
    invoke-static {v0, v3}, LX/0W6;->A01(Landroid/content/SharedPreferences;Ljava/lang/String;)LX/0VW;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-static {v5, v3, v0, v1}, LX/0W6;->A00(Landroid/content/Context;Ljava/lang/String;LX/0VW;Z)LX/0VW;

    goto :goto_3
    :try_end_7
    .catch LX/0W7; {:try_start_7 .. :try_end_7} :catch_3
    ...
    invoke-virtual {v7, v5, v3}, LX/0W6;->A09(Landroid/content/Context;Ljava/lang/String;)LX/0VW;

    move-result-object v6

    goto :goto_4
    :try_end_8
    .catch LX/0W7; {:try_start_8 .. :try_end_8} :catch_4
    ...
    iget-object v1, v2, LX/0Vl;->A02:LX/0W6;

    iget-object v0, v2, LX/0Vl;->A00:Landroid/content/Context;

    invoke-virtual {v1, v0, v3}, LX/0W6;->A09(Landroid/content/Context;Ljava/lang/String;)LX/0VW;
    ...
    iget-object v0, v6, LX/0VW;->A01:Ljava/security/KeyPair;
...
.method public static A03(Ljava/lang/Runnable;J)V
    ...
    invoke-direct {v1, v0}, LX/0Oq;-><init>(Ljava/lang/String;)V
...
.method public static getInstance(LX/0VA;)Lcom/google/firebase/iid/FirebaseInstanceId;
    .locals 2
    ...
    iget-object v0, p0, LX/0VA;->A03:LX/1f8;
...
# virtual methods
.method public final A05(LX/0Rw;)Ljava/lang/Object;
    .locals 3
    ...
    invoke-static {p1, v1, v2, v0}, LX/0OC;->A0V(LX/0Rw;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method public A06(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, p0, p1, v3}, LX/1fP;-><init>(Lcom/google/firebase/iid/FirebaseInstanceId;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2, v1, v0}, LX/0Rw;->A03(Ljava/util/concurrent/Executor;LX/0Rq;)LX/0Rw;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceId;->A05(LX/0Rw;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, LX/1fU;

    iget-object v0, v0, LX/1fU;->A00:Ljava/lang/String;
...
.method public final A07()V
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A02:LX/0VA;
    ...
    invoke-virtual {p0, v0}, Lcom/google/firebase/iid/FirebaseInstanceId;->A0C(LX/0Vk;)Z

    move-result v0

    if-nez v0, :cond_1

    iget-object v2, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A06:LX/0Vp;

    monitor-enter v2

    :try_start_0
    invoke-virtual {v2}, LX/0Vp;->A00()Ljava/lang/String;
...
.method public final declared-synchronized A0A(J)V
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A06:LX/0Vp;

    invoke-direct {v1, p0, v0, v2, v3}, LX/0Vn;-><init>(Lcom/google/firebase/iid/FirebaseInstanceId;LX/0Vp;J)V
...
.method public final A0C(LX/0Vk;)Z
    .locals 9
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/FirebaseInstanceId;->A04:LX/0Vg;
    ...
    iget-wide v3, p1, LX/0Vk;->A00:J

    sget-wide v0, LX/0Vk;->A03:J
    ...
    iget-object v0, p1, LX/0Vk;->A02:Ljava/lang/String;
