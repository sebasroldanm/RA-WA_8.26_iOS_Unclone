...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, LX/1ef;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance v0, LX/1eg;

    invoke-direct {v0, p0}, LX/1eg;-><init>(Lcom/google/android/material/internal/NavigationMenuItemView;)V

    iput-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A09:LX/06N;
    ...
    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A09:LX/06N;
...
.method public A8C(LX/1Un;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A03:LX/1Un;
    ...
    :goto_0
    invoke-static {p0, v6}, LX/06i;->A0b(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    :cond_1
    invoke-virtual {p1}, LX/1Un;->isCheckable()Z

    move-result v0

    invoke-virtual {p0, v0}, Lcom/google/android/material/internal/NavigationMenuItemView;->setCheckable(Z)V

    invoke-virtual {p1}, LX/1Un;->isChecked()Z
    ...
    iget-object v0, p1, LX/1Un;->A0I:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, Landroid/view/ViewGroup;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object v0, p1, LX/1Un;->A0L:Ljava/lang/CharSequence;

    invoke-static {p0, v0}, LX/03w;->A0k(Landroid/view/View;Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A03:LX/1Un;

    iget-object v0, v1, LX/1Un;->A0J:Ljava/lang/CharSequence;

    if-nez v0, :cond_4

    invoke-virtual {v1}, LX/1Un;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_4

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A03:LX/1Un;

    invoke-virtual {v0}, LX/1Un;->getActionView()Landroid/view/View;
...
.method public onCreateDrawableState(I)[I
    ...
    invoke-virtual {v1}, LX/1Un;->isCheckable()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v1}, LX/1Un;->isChecked()Z
...
.method public setCheckable(Z)V
    ...
    iget-object v2, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A09:LX/06N;

    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->A08:Landroid/widget/CheckedTextView;

    const/16 v0, 0x800

    invoke-virtual {v2, v1, v0}, LX/06N;->A01(Landroid/view/View;I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1, p1, v0, v0, v0}, LX/03w;->A0t(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v2, v1, v0}, LX/03w;->A0G(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
