...
.method public synthetic constructor <init>(LX/0w9;ZLjava/util/List;Ljava/lang/String;LX/0w8;Landroid/net/Uri;LX/0r3;)V
    ...
    iput-object p1, p0, LX/1ir;->A03:LX/0w9;

    iput-boolean p2, p0, LX/1ir;->A06:Z

    iput-object p3, p0, LX/1ir;->A05:Ljava/util/List;

    iput-object p4, p0, LX/1ir;->A04:Ljava/lang/String;

    iput-object p5, p0, LX/1ir;->A02:LX/0w8;

    iput-object p6, p0, LX/1ir;->A00:Landroid/net/Uri;

    iput-object p7, p0, LX/1ir;->A01:LX/0r3;
...
.method public final ACW(Ljava/io/File;)V
    ...
    iget-object v5, p0, LX/1ir;->A03:LX/0w9;

    iget-boolean v6, p0, LX/1ir;->A06:Z

    iget-object v7, p0, LX/1ir;->A05:Ljava/util/List;

    iget-object v12, p0, LX/1ir;->A04:Ljava/lang/String;

    iget-object v2, p0, LX/1ir;->A02:LX/0w8;

    iget-object v1, p0, LX/1ir;->A00:Landroid/net/Uri;

    iget-object v3, p0, LX/1ir;->A01:LX/0r3;
    ...
    invoke-interface {v2}, LX/0w8;->ACK()V

    :cond_0
    invoke-interface {v2, v1}, LX/0w8;->AHX(Landroid/net/Uri;)V
