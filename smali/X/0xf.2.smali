...
.method public constructor <init>(II)V
    ...
    iput-object v0, p0, LX/0xf;->A08:Ljava/lang/Object;
    ...
    iput-object v1, p0, LX/0xf;->A03:Ljavax/microedition/khronos/egl/EGL10;
    ...
    iput-object v2, p0, LX/0xf;->A05:Ljavax/microedition/khronos/egl/EGLDisplay;

    iget-object v1, p0, LX/0xf;->A03:Ljavax/microedition/khronos/egl/EGL10;
    ...
    iget-object v5, p0, LX/0xf;->A03:Ljavax/microedition/khronos/egl/EGL10;

    iget-object v6, p0, LX/0xf;->A05:Ljavax/microedition/khronos/egl/EGLDisplay;
    ...
    iget-object v6, p0, LX/0xf;->A03:Ljavax/microedition/khronos/egl/EGL10;

    iget-object v5, p0, LX/0xf;->A05:Ljavax/microedition/khronos/egl/EGLDisplay;
    ...
    iput-object v0, p0, LX/0xf;->A04:Ljavax/microedition/khronos/egl/EGLContext;

    const-string v0, "eglCreateContext"

    invoke-virtual {p0, v0}, LX/0xf;->A01(Ljava/lang/String;)V

    iget-object v0, p0, LX/0xf;->A04:Ljavax/microedition/khronos/egl/EGLContext;
    ...
    iget-object v3, p0, LX/0xf;->A03:Ljavax/microedition/khronos/egl/EGL10;

    iget-object v1, p0, LX/0xf;->A05:Ljavax/microedition/khronos/egl/EGLDisplay;
    ...
    iput-object v0, p0, LX/0xf;->A06:Ljavax/microedition/khronos/egl/EGLSurface;

    const-string v0, "eglCreatePbufferSurface"

    invoke-virtual {p0, v0}, LX/0xf;->A01(Ljava/lang/String;)V

    iget-object v0, p0, LX/0xf;->A06:Ljavax/microedition/khronos/egl/EGLSurface;

    if-eqz v0, :cond_8

    invoke-virtual {p0}, LX/0xf;->A00()V

    new-instance v5, LX/0xg;

    invoke-direct {v5}, LX/0xg;-><init>()V

    iput-object v5, p0, LX/0xf;->A02:LX/0xg;

    const v1, 0x8b31

    const-string v0, "uniform mat4 uMVPMatrix;\nuniform mat4 uSTMatrix;\nattribute vec4 aPosition;\nattribute vec4 aTextureCoord;\nvarying vec2 vTextureCoord;\nvoid main() {\n  gl_Position = uMVPMatrix * aPosition;\n  vTextureCoord = (uSTMatrix * aTextureCoord).xy;\n}\n"

    invoke-virtual {v5, v1, v0}, LX/0xg;->A01(ILjava/lang/String;)I
    ...
    invoke-static {v0}, LX/0xg;->A00(Ljava/lang/String;)V
    ...
    iput v0, v5, LX/0xg;->A00:I

    const-string v0, "glGetAttribLocation aPosition"

    invoke-static {v0}, LX/0xg;->A00(Ljava/lang/String;)V

    iget v0, v5, LX/0xg;->A00:I

    const/4 v3, -0x1

    if-eq v0, v3, :cond_6

    iget v1, v5, LX/0xg;->A02:I
    ...
    iput v0, v5, LX/0xg;->A01:I

    const-string v0, "glGetAttribLocation aTextureCoord"

    invoke-static {v0}, LX/0xg;->A00(Ljava/lang/String;)V

    iget v0, v5, LX/0xg;->A01:I
    ...
    iput v0, v5, LX/0xg;->A04:I

    const-string v0, "glGetUniformLocation uMVPMatrix"

    invoke-static {v0}, LX/0xg;->A00(Ljava/lang/String;)V

    iget v0, v5, LX/0xg;->A04:I
    ...
    iput v0, v5, LX/0xg;->A05:I

    const-string v0, "glGetUniformLocation uSTMatrix"

    invoke-static {v0}, LX/0xg;->A00(Ljava/lang/String;)V

    iget v0, v5, LX/0xg;->A05:I
    ...
    iget-object v0, p0, LX/0xf;->A02:LX/0xg;

    iget v0, v0, LX/0xg;->A03:I

    invoke-direct {v1, v0}, Landroid/graphics/SurfaceTexture;-><init>(I)V

    iput-object v1, p0, LX/0xf;->A00:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v1, p0}, Landroid/graphics/SurfaceTexture;->setOnFrameAvailableListener(Landroid/graphics/SurfaceTexture$OnFrameAvailableListener;)V

    new-instance v1, Landroid/view/Surface;

    iget-object v0, p0, LX/0xf;->A00:Landroid/graphics/SurfaceTexture;

    invoke-direct {v1, v0}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v1, p0, LX/0xf;->A01:Landroid/view/Surface;
...
.method public A00()V
    ...
    iget-object v0, p0, LX/0xf;->A03:Ljavax/microedition/khronos/egl/EGL10;
    ...
    iget-object v2, p0, LX/0xf;->A05:Ljavax/microedition/khronos/egl/EGLDisplay;

    iget-object v1, p0, LX/0xf;->A06:Ljavax/microedition/khronos/egl/EGLSurface;
...
.method public onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v2, p0, LX/0xf;->A08:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-boolean v0, p0, LX/0xf;->A07:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, LX/0xf;->A07:Z

    iget-object v0, p0, LX/0xf;->A08:Ljava/lang/Object;
