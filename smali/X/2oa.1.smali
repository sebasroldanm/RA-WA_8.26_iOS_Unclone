...
.method public static constructor <clinit>()V
    ...
    sput-object v0, LX/2oa;->A00:Ljava/lang/Object;
...
.method public static A00(Ljava/lang/String;Ljava/io/File;)I
    ...
    .catch LX/2pV; {:try_start_0 .. :try_end_0} :catch_6
    .catch LX/2oY; {:try_start_0 .. :try_end_0} :catch_5
    ...
    .catch LX/2pV; {:try_start_1 .. :try_end_1} :catch_6
    .catch LX/2oY; {:try_start_1 .. :try_end_1} :catch_5
    ...
    invoke-static {v4, v0}, LX/2oa;->A01(Ljava/util/zip/ZipFile;Ljava/lang/String;)I
    ...
    if-eqz v0, :cond_4
    :try_end_5
    .catch Ljava/util/zip/ZipException; {:try_start_5 .. :try_end_5} :catch_6
    .catch LX/2pV; {:try_start_5 .. :try_end_5} :catch_6
    .catch LX/2oY; {:try_start_5 .. :try_end_5} :catch_5
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_6 .. :try_end_6} :catch_6
    .catch LX/2pV; {:try_start_6 .. :try_end_6} :catch_6
    .catch LX/2oY; {:try_start_6 .. :try_end_6} :catch_5
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_8 .. :try_end_8} :catch_6
    .catch LX/2pV; {:try_start_8 .. :try_end_8} :catch_6
    .catch LX/2oY; {:try_start_8 .. :try_end_8} :catch_5
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_c .. :try_end_c} :catch_6
    .catch LX/2pV; {:try_start_c .. :try_end_c} :catch_6
    .catch LX/2oY; {:try_start_c .. :try_end_c} :catch_5
    ...
    const-string v3, "documentutils/slidecount "
    :try_end_d
    .catch Ljava/util/zip/ZipException; {:try_start_d .. :try_end_d} :catch_6
    .catch LX/2pV; {:try_start_d .. :try_end_d} :catch_6
    .catch LX/2oY; {:try_start_d .. :try_end_d} :catch_5
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_e .. :try_end_e} :catch_6
    .catch LX/2pV; {:try_start_e .. :try_end_e} :catch_6
    .catch LX/2oY; {:try_start_e .. :try_end_e} :catch_5
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_12 .. :try_end_12} :catch_6
    .catch LX/2pV; {:try_start_12 .. :try_end_12} :catch_6
    .catch LX/2oY; {:try_start_12 .. :try_end_12} :catch_5
    ...
    .catch Ljava/util/zip/ZipException; {:try_start_16 .. :try_end_16} :catch_6
    .catch LX/2pV; {:try_start_16 .. :try_end_16} :catch_6
    .catch LX/2oY; {:try_start_16 .. :try_end_16} :catch_5
    ...
    throw v0
    :try_end_17
    .catch Ljava/util/zip/ZipException; {:try_start_17 .. :try_end_17} :catch_6
    .catch LX/2pV; {:try_start_17 .. :try_end_17} :catch_6
    .catch LX/2oY; {:try_start_17 .. :try_end_17} :catch_5
...
.method public static A02(Ljava/lang/String;IIZ)Landroid/graphics/Bitmap;
    ...
    sget-object v10, LX/2oa;->A00:Ljava/lang/Object;
...
.method public static A03(Landroid/content/Context;LX/2Gt;)Landroid/graphics/drawable/Drawable;
    .locals 2
    ...
    invoke-static {p0, v0, v1}, LX/2oa;->A04(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method public static A04(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    invoke-direct {v2, p0, v1, v0}, LX/0r6;-><init>(Landroid/content/Context;ILjava/lang/String;)V
    ...
    :goto_2
    invoke-direct {v3, p0, v2, v0}, LX/0r6;-><init>(Landroid/content/Context;ILjava/lang/String;)V
...
.method public static A05(LX/17T;Landroid/net/Uri;)Ljava/lang/String;
    .locals 8
...
.method public static A06(LX/181;Ljava/lang/String;I)Ljava/lang/String;
    .locals 6
    ...
    invoke-virtual {p0, v4, v2, v3, v1}, LX/181;->A09(IJ[Ljava/lang/Object;)Ljava/lang/String;
...
.method public static A08(Ljava/lang/String;Ljava/io/File;)[B
    ...
    invoke-static {v1, v0, v0, v0}, LX/2oa;->A02(Ljava/lang/String;IIZ)Landroid/graphics/Bitmap;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-static {v1}, LX/2oa;->A07(Landroid/graphics/Bitmap;)[B
    ...
    invoke-static {v4, v1}, LX/0OC;->A0E(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_3
    invoke-static {v7}, LX/2oa;->A07(Landroid/graphics/Bitmap;)[B
