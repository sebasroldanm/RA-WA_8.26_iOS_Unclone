...
# direct methods
.method public constructor <init>(LX/1vU;LX/0pU;LX/13q;LX/181;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LX/15R;->A02:LX/1vU;

    iput-object p2, p0, LX/15R;->A00:LX/0pU;

    iput-object p3, p0, LX/15R;->A01:LX/13q;

    iput-object p4, p0, LX/15R;->A03:LX/181;
...
.method public run()V
    ...
    iget-object v12, v1, LX/1vU;->A0D:LX/1DL;

    iget-object v6, v1, LX/1vU;->A00:Landroid/view/View;

    iget-object v11, v1, LX/1vU;->A07:Landroid/widget/TextView;

    iget-object v10, v1, LX/1vU;->A09:LX/0xI;

    iget-object v2, v1, LX/1vU;->A08:Landroid/widget/TextView;

    iget-object v13, v1, LX/1vU;->A01:Landroid/view/View;

    iget-object v1, v0, LX/15R;->A00:LX/0pU;

    invoke-virtual {v1, v12}, LX/0pU;->A03(LX/1DL;)Ljava/lang/String;

    move-result-object v1

    iget-object v3, v0, LX/15R;->A00:LX/0pU;

    invoke-virtual {v3, v12}, LX/0pU;->A01(LX/1DL;)Ljava/lang/String;

    move-result-object v3

    iget-object v7, v0, LX/15R;->A02:LX/1vU;

    iget-object v5, v7, LX/1vU;->A0D:LX/1DL;

    iget-object v4, v5, LX/1DL;->A08:LX/1DJ;

    if-eqz v4, :cond_0

    invoke-virtual {v5}, LX/1DL;->A09()Z

    move-result v4

    if-eqz v4, :cond_0

    iget-object v4, v7, LX/1vU;->A0D:LX/1DL;

    invoke-static {v4}, LX/13q;->A03(LX/1DL;)Z
    ...
    iget-object v4, v10, LX/0xI;->A02:Lcom/whatsapp/TextEmojiLabel;

    invoke-virtual {v4}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;

    move-result-object v5

    invoke-virtual {v12}, LX/1DL;->A05()Ljava/lang/String;
    ...
    iget-object v4, v0, LX/15R;->A02:LX/1vU;

    iget-object v4, v4, LX/1vU;->A0F:LX/2Jw;
    ...
    iget-object v5, v0, LX/15R;->A03:LX/181;
    ...
    invoke-direct {v5, v6}, LX/1vZ;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v4, v0, v2, v1}, LX/1va;-><init>(LX/15R;Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    iget-object v0, v0, LX/15R;->A03:LX/181;
