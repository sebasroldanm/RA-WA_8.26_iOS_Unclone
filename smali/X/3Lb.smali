...
# direct methods
.method public constructor <init>(LX/0rz;LX/2Y5;LX/2Y9;Ljava/lang/String;LX/2Y0;)V
    .locals 0

    iput-object p5, p0, LX/3Lb;->A00:LX/2Y0;
...
.method public A00(LX/1PY;)V
    ...
    iget-object v0, p0, LX/3Lb;->A00:LX/2Y0;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, LX/2Y0;->AFC(LX/1PY;)V
...
.method public A02(LX/1QX;)V
    ...
    iget-object v1, p0, LX/3Lb;->A00:LX/2Y0;

    if-eqz v1, :cond_0

    const/4 v0, 0x0

    invoke-interface {v1, v0}, LX/2Y0;->AFC(LX/1PY;)V
