...
# direct methods
.method public constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceId;LX/0VR;)V
    .locals 6

    iput-object p1, p0, LX/0VS;->A03:Lcom/google/firebase/iid/FirebaseInstanceId;
    ...
    :catch_0
    iget-object v0, p1, Lcom/google/firebase/iid/FirebaseInstanceId;->A02:LX/0VA;

    invoke-virtual {v0}, LX/0VA;->A03()V

    iget-object v2, v0, LX/0VA;->A00:Landroid/content/Context;
    ...
    :goto_0
    iput-boolean v3, p0, LX/0VS;->A02:Z

    const-string v4, "firebase_messaging_auto_init_enabled"

    iget-object v0, p0, LX/0VS;->A03:Lcom/google/firebase/iid/FirebaseInstanceId;

    iget-object v0, v0, Lcom/google/firebase/iid/FirebaseInstanceId;->A02:LX/0VA;

    invoke-virtual {v0}, LX/0VA;->A03()V

    iget-object v3, v0, LX/0VA;->A00:Landroid/content/Context;
    ...
    :goto_1
    iput-object v0, p0, LX/0VS;->A01:Ljava/lang/Boolean;

    if-nez v0, :cond_4

    iget-boolean v0, p0, LX/0VS;->A02:Z

    if-eqz v0, :cond_4

    new-instance v4, LX/1fQ;

    invoke-direct {v4, p0}, LX/1fQ;-><init>(LX/0VS;)V

    iput-object v4, p0, LX/0VS;->A00:LX/0VP;

    const-class v3, LX/0V6;

    check-cast p2, LX/1fA;

    iget-object v2, p2, LX/1fA;->A02:Ljava/util/concurrent/Executor;
    ...
    iget-object v0, p2, LX/1fA;->A01:Ljava/util/Map;
    ...
    iget-object v1, p2, LX/1fA;->A01:Ljava/util/Map;
...
.method public final declared-synchronized A00()Z
    ...
    :try_start_0
    iget-object v0, p0, LX/0VS;->A01:Ljava/lang/Boolean;
    ...
    iget-object v0, v0, LX/0VA;->A07:Ljava/util/concurrent/atomic/AtomicBoolean;
