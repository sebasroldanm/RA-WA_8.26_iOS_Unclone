...
.method public constructor <init>(Lcom/google/android/material/tabs/TabLayout;Landroid/content/Context;)V
    ...
    iput-object p1, p0, LX/0UY;->A08:Lcom/google/android/material/tabs/TabLayout;
    ...
    invoke-virtual {p0, p2}, LX/0UY;->A01(Landroid/content/Context;)V
    ...
    invoke-direct {v1, v0}, LX/06b;-><init>(Ljava/lang/Object;)V
    ...
    iget-object v0, v1, LX/06b;->A00:Ljava/lang/Object;
...
.method public final A00()V
    ...
    iget-object v4, p0, LX/0UY;->A07:LX/0UX;

    const/4 v3, 0x0

    if-eqz v4, :cond_12

    iget-object v2, v4, LX/0UX;->A02:Landroid/view/View;
    ...
    :cond_1
    iput-object v2, p0, LX/0UY;->A02:Landroid/view/View;

    iget-object v0, p0, LX/0UY;->A06:Landroid/widget/TextView;
    ...
    :cond_2
    iget-object v0, p0, LX/0UY;->A04:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, LX/0UY;->A05:Landroid/widget/TextView;

    if-eqz v0, :cond_4

    invoke-static {v0}, LX/03w;->A02(Landroid/widget/TextView;)I
    ...
    iput-object v0, p0, LX/0UY;->A03:Landroid/widget/ImageView;

    :goto_1
    iget-object v0, p0, LX/0UY;->A02:Landroid/view/View;
    ...
    iput-object v0, p0, LX/0UY;->A04:Landroid/widget/ImageView;

    :cond_5
    if-eqz v4, :cond_6

    iget-object v0, v4, LX/0UX;->A01:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, LX/0UY;->A08:Lcom/google/android/material/tabs/TabLayout;

    iget-object v0, v0, Lcom/google/android/material/tabs/TabLayout;->A0E:Landroid/content/res/ColorStateList;

    invoke-static {v3, v0}, LX/03w;->A0f(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v3, v0}, LX/03w;->A0g(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object v0, p0, LX/0UY;->A06:Landroid/widget/TextView;
    ...
    :cond_8
    iget-object v1, p0, LX/0UY;->A06:Landroid/widget/TextView;

    iget-object v0, p0, LX/0UY;->A08:Lcom/google/android/material/tabs/TabLayout;

    iget v0, v0, Lcom/google/android/material/tabs/TabLayout;->A0C:I

    invoke-static {v1, v0}, LX/03w;->A0q(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v1, v0}, LX/0UY;->A02(Landroid/widget/TextView;Landroid/widget/ImageView;)V

    :cond_a
    :goto_2
    if-eqz v4, :cond_b

    iget-object v0, v4, LX/0UX;->A05:Ljava/lang/CharSequence;
    ...
    iget-object v0, v4, LX/0UX;->A04:Lcom/google/android/material/tabs/TabLayout;
    ...
    :goto_3
    invoke-virtual {p0, v3}, LX/0UY;->setSelected(Z)V
    ...
    :cond_e
    iget-object v1, p0, LX/0UY;->A05:Landroid/widget/TextView;

    if-nez v1, :cond_f

    iget-object v0, p0, LX/0UY;->A03:Landroid/widget/ImageView;
    ...
    iput-object v3, p0, LX/0UY;->A02:Landroid/view/View;

    :cond_11
    iput-object v3, p0, LX/0UY;->A05:Landroid/widget/TextView;

    iput-object v3, p0, LX/0UY;->A03:Landroid/widget/ImageView;
...
.method public final A01(Landroid/content/Context;)V
    ...
    iput-object v0, p0, LX/0UY;->A01:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, LX/0UY;->A01:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    :goto_1
    invoke-static {p0, v4}, LX/06i;->A0b(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_4
    invoke-static {v3}, LX/03w;->A0H(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v3

    invoke-static {v3, v2}, LX/03w;->A0f(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    :cond_5
    iput-object v6, p0, LX/0UY;->A01:Landroid/graphics/drawable/Drawable;
...
.method public final A02(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    iget-object v0, p0, LX/0UY;->A07:LX/0UX;

    const/4 v3, 0x0

    if-eqz v0, :cond_d

    iget-object v0, v0, LX/0UX;->A01:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, v0, LX/0UX;->A06:Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, LX/0UX;->A05:Ljava/lang/CharSequence;
    ...
    :cond_3
    invoke-static {p0, v0}, LX/03w;->A0k(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public drawableStateChanged()V
    ...
    iget-object v0, p0, LX/0UY;->A01:Landroid/graphics/drawable/Drawable;
...
.method public setTab(LX/0UX;)V
    ...
    iput-object p1, p0, LX/0UY;->A07:LX/0UX;

    invoke-virtual {p0}, LX/0UY;->A00()V
