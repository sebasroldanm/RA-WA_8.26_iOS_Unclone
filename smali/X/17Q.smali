...
# static fields
.field public static volatile A01:LX/17Q;
...
.method public constructor <init>(LX/17T;)V
    ...
    iput-object p1, p0, LX/17Q;->A00:LX/17T;

    return-void
.end method

.method public static A00()LX/17Q;
    .locals 3

    sget-object v0, LX/17Q;->A01:LX/17Q;

    if-nez v0, :cond_1

    const-class v2, LX/17Q;
    ...
    invoke-direct {v1, v0}, LX/17Q;-><init>(LX/17T;)V

    sput-object v1, LX/17Q;->A01:LX/17Q;
...
# virtual methods
.method public A02(Z)I
    .locals 7

    iget-object v0, p0, LX/17Q;->A00:LX/17T;
    ...
    invoke-static {v0, p1}, Lcom/whatsapp/core/NetworkStateManager$SubscriptionManagerBasedRoamingDetector;->determineNetworkStateUsingSubscriptionManager(LX/17T;Z)Landroid/util/Pair;
    ...
    sget-object v1, LX/1Rq;->A00:Ljava/util/HashSet;
...
.method public A03()Landroid/net/NetworkInfo;
    .locals 1
