...
.method public constructor <init>(Landroid/net/ConnectivityManager;)V
    ...
    iput-object p1, p0, LX/2t6;->A04:Landroid/net/ConnectivityManager;

    iput-object v1, p0, LX/2t6;->A05:LX/2t4;

    iput-object v0, p0, LX/2t6;->A06:Ljava/util/concurrent/ExecutorService;

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/2t6;->A03:Z
...
.method public final A00(Landroid/net/Network;Z)V
    ...
    iget-object v0, p0, LX/2t6;->A02:Ljava/net/DatagramSocket;
    ...
    iput-object p1, p0, LX/2t6;->A01:Landroid/net/Network;

    new-instance v1, Ljava/net/DatagramSocket;

    invoke-direct {v1}, Ljava/net/DatagramSocket;-><init>()V

    iput-object v1, p0, LX/2t6;->A02:Ljava/net/DatagramSocket;

    iget-object v0, p0, LX/2t6;->A01:Landroid/net/Network;
    ...
    :goto_0
    iget-object v2, p0, LX/2t6;->A02:Ljava/net/DatagramSocket;
    ...
    :cond_4
    invoke-virtual {p0, v3}, LX/2t6;->A01(Z)V
...
.method public final A01(Z)V
    ...
    iput-object v2, p0, LX/2t6;->A02:Ljava/net/DatagramSocket;

    :cond_0
    if-eqz p1, :cond_2

    iget-object v1, p0, LX/2t6;->A00:Landroid/net/ConnectivityManager$NetworkCallback;

    if-eqz v1, :cond_1

    :try_start_0
    iget-object v0, p0, LX/2t6;->A04:Landroid/net/ConnectivityManager;
    ...
    :goto_0
    iput-object v2, p0, LX/2t6;->A00:Landroid/net/ConnectivityManager$NetworkCallback;

    :cond_1
    iput-object v2, p0, LX/2t6;->A01:Landroid/net/Network;
...
.method public synthetic A02(ZZ)V
    ...
    iget-boolean v0, p0, LX/2t6;->A03:Z
    ...
    invoke-virtual {p0, v0, p2}, LX/2t6;->A00(Landroid/net/Network;Z)V
    ...
    invoke-direct {v0, p0, p2}, LX/2t5;-><init>(LX/2t6;Z)V

    iput-object v0, p0, LX/2t6;->A00:Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    iget-object v3, p0, LX/2t6;->A04:Landroid/net/ConnectivityManager;
    ...
    :cond_6
    iget-object v2, p0, LX/2t6;->A04:Landroid/net/ConnectivityManager;

    invoke-virtual {v4}, Landroid/net/NetworkRequest$Builder;->build()Landroid/net/NetworkRequest;

    move-result-object v1

    iget-object v0, p0, LX/2t6;->A00:Landroid/net/ConnectivityManager$NetworkCallback;
