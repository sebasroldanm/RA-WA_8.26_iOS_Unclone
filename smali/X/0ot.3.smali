...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;LX/0ov;)V
    .locals 2
    ...
    iput-object p2, p0, LX/0ot;->A03:Ljava/lang/String;

    iput-object p1, p0, LX/0ot;->A01:Landroid/content/Context;

    iput-object p3, p0, LX/0ot;->A02:LX/0ov;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantReadWriteLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;-><init>()V

    iput-object v0, p0, LX/0ot;->A04:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
...
.method public declared-synchronized A01()LX/1Dm;
    ...
    :try_start_0
    iget-object v0, p0, LX/0ot;->A00:LX/1Dm;
    ...
    iput-object v0, p0, LX/0ot;->A00:LX/1Dm;
    ...
    invoke-virtual {p0}, LX/0ot;->A02()Z
...
.method public A02()Z
    ...
    iget-object v1, p0, LX/0ot;->A01:Landroid/content/Context;

    iget-object v0, p0, LX/0ot;->A03:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/0ot;->A01:Landroid/content/Context;
...
.method public declared-synchronized getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_1
    invoke-virtual {p0}, LX/0ot;->A01()LX/1Dm;
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {p0, p1}, LX/0ot;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p1, v3, v4, v0, v2}, LX/0ot;->A00(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "BOOLEAN"

    const-string v0, "pinned"

    invoke-static {p1, v3, v4, v0, v1}, LX/0ot;->A00(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, LX/0ot;->A02:LX/0ov;

    invoke-virtual {v0, p1}, LX/0ov;->A0E(Landroid/database/sqlite/SQLiteDatabase;)V
