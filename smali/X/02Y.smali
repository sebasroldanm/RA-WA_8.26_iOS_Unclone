...
.method public constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    iput-object v0, p0, LX/02Y;->A00:Landroid/content/res/ColorStateList;

    iput-object v0, p0, LX/02Y;->A01:Landroid/graphics/PorterDuff$Mode;

    const/4 v0, 0x0

    iput-boolean v0, p0, LX/02Y;->A02:Z

    iput-boolean v0, p0, LX/02Y;->A03:Z

    iput-object p1, p0, LX/02Y;->A05:Landroid/widget/CompoundButton;
...
.method public A00(I)I
    ...
    iget-object v0, p0, LX/02Y;->A05:Landroid/widget/CompoundButton;

    invoke-static {v0}, LX/00O;->A06(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;
...
.method public A01()V
    ...
    iget-boolean v0, p0, LX/02Y;->A02:Z

    if-nez v0, :cond_0

    iget-boolean v0, p0, LX/02Y;->A03:Z
    ...
    iget-object v0, p0, LX/02Y;->A00:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, LX/02Y;->A01:Landroid/graphics/PorterDuff$Mode;
...
.method public A02(Landroid/util/AttributeSet;I)V
    ...
    :try_start_1
    iget-object v1, p0, LX/02Y;->A05:Landroid/widget/CompoundButton;

    invoke-virtual {v1}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v0, v2}, LX/01e;->A01(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, LX/02Y;->A05:Landroid/widget/CompoundButton;
    ...
    invoke-interface {v2, v1}, LX/07F;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {v2, v1}, LX/07F;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
    :try_end_2
