...
# static fields
.field public static volatile A07:LX/3Gp;
...
# direct methods
.method public constructor <init>(LX/17T;LX/181;LX/1Sl;)V
    .locals 2
    ...
    iput-object v0, p0, LX/3Gp;->A05:Ljava/util/concurrent/ConcurrentMap;

    iget-object v0, p1, LX/17T;->A0B:Landroid/telecom/TelecomManager;

    if-nez v0, :cond_0

    iget-object v0, p1, LX/17T;->A0G:LX/17X;
    ...
    iput-object v0, p1, LX/17T;->A0B:Landroid/telecom/TelecomManager;

    :cond_0
    iget-object v0, p1, LX/17T;->A0B:Landroid/telecom/TelecomManager;

    iput-object v0, p0, LX/3Gp;->A02:Landroid/telecom/TelecomManager;

    iput-object p2, p0, LX/3Gp;->A03:LX/181;

    iput-object p3, p0, LX/3Gp;->A04:LX/1Sl;
...
.method public static final A00(Lcom/whatsapp/jid/UserJid;)Landroid/net/Uri;
    ...
    invoke-static {p0}, LX/13r;->A01(LX/254;)Ljava/lang/String;
...
.method public static A02()LX/3Gp;
    .locals 5

    sget-object v0, LX/3Gp;->A07:LX/3Gp;

    if-nez v0, :cond_1

    const-class v4, LX/3Gp;
    ...
    invoke-direct {v3, v2, v1, v0}, LX/3Gp;-><init>(LX/17T;LX/181;LX/1Sl;)V

    sput-object v3, LX/3Gp;->A07:LX/3Gp;
...
# virtual methods
.method public A03(Landroid/telecom/ConnectionRequest;Z)Landroid/telecom/Connection;
    .locals 7
    ...
    invoke-direct {v2, p0, v3}, LX/2tA;-><init>(LX/3Gp;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, LX/3Gp;->A04(LX/2tA;)V
    ...
    invoke-interface {v0, v3}, LX/2tC;->ABN(Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    invoke-interface {v0, v3}, LX/2tC;->ABI(Ljava/lang/String;)V
...
.method public A04(LX/2tA;)V
    .locals 2

    invoke-static {}, LX/1Ru;->A01()V

    iget-object v1, p0, LX/3Gp;->A05:Ljava/util/concurrent/ConcurrentMap;

    iget-object v0, p1, LX/2tA;->A01:Ljava/lang/String;
    ...
    iget-object v0, p0, LX/3Gp;->A05:Ljava/util/concurrent/ConcurrentMap;
...
.method public A06(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, LX/2tA;->A00(I)V
...
.method public A07(Ljava/lang/String;I)V
    ...
    invoke-interface {v0, p1, p2}, LX/2tC;->AB8(Ljava/lang/String;I)V
...
.method public A08()Z
    ...
    iget-object v0, p0, LX/3Gp;->A04:LX/1Sl;
    ...
    :cond_0
    iput-boolean v2, p0, LX/3Gp;->A01:Z

    return v2
.end method

.method public A09(Landroid/content/Context;Lcom/whatsapp/jid/UserJid;)Z
    .locals 6

    invoke-static {}, LX/1Ru;->A01()V

    iget-object v0, p0, LX/3Gp;->A00:Landroid/telecom/PhoneAccountHandle;

    const/4 v5, 0x1

    if-nez v0, :cond_3

    iget-object v0, p0, LX/3Gp;->A02:Landroid/telecom/TelecomManager;
    ...
    :cond_0
    invoke-static {p2}, LX/3Gp;->A00(Lcom/whatsapp/jid/UserJid;)Landroid/net/Uri;
    ...
    iput-object v2, p0, LX/3Gp;->A00:Landroid/telecom/PhoneAccountHandle;

    iget-object v1, p0, LX/3Gp;->A03:LX/181;
    ...
    iput-object v0, p0, LX/3Gp;->A00:Landroid/telecom/PhoneAccountHandle;
...
.method public A0A(Ljava/lang/String;Lcom/whatsapp/jid/UserJid;Ljava/lang/String;Z)Z
    .locals 7
    ...
    iget-boolean v0, p0, LX/3Gp;->A01:Z
    ...
    :cond_0
    iget-object v1, p0, LX/3Gp;->A02:Landroid/telecom/TelecomManager;
    ...
    :cond_7
    invoke-static {p1, p2, p3, v0, v3}, LX/3Gp;->A01(Ljava/lang/String;Lcom/whatsapp/jid/UserJid;Ljava/lang/String;ZZ)Landroid/os/Bundle;

    move-result-object v2

    iget-object v1, p0, LX/3Gp;->A00:Landroid/telecom/PhoneAccountHandle;
