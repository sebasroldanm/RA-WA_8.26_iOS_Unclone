...
.method public constructor <init>(LX/1US;)V
    ...
    iput-object p1, p0, LX/01Z;->A00:LX/1US;
...
.method public run()V
    ...
    iget-object v5, p0, LX/01Z;->A00:LX/1US;

    invoke-virtual {v5}, LX/1US;->A0T()Landroid/view/Menu;
    ...
    invoke-virtual {v2}, LX/1Uk;->A07()V

    :cond_1
    :try_start_0
    invoke-interface {v4}, Landroid/view/Menu;->clear()V

    iget-object v0, v5, LX/1US;->A00:Landroid/view/Window$Callback;
    ...
    invoke-virtual {v2}, LX/1Uk;->A06()V
