...
# instance fields
.field public final synthetic A00:LX/3Lo;


# direct methods
.method public constructor <init>(LX/3Lo;LX/0rz;LX/2Y5;)V
    .locals 0

    iput-object p1, p0, LX/3Ja;->A00:LX/3Lo;
...
.method public A00(LX/1PY;)V
    ...
    iget-object v0, p0, LX/3Ja;->A00:LX/3Lo;
...
.method public A01(LX/1PY;)V
    ...
    iget-object v1, v0, LX/3Lo;->A04:LX/1Pc;

    const/4 v0, 0x2

    invoke-virtual {v1, v0, v2}, LX/1Pc;->A02(ILX/1PU;)V

    :cond_0
    iget-object v0, p0, LX/3Ja;->A00:LX/3Lo;

    iget-object v0, v0, LX/3Lo;->A06:LX/2Z0;

    invoke-interface {v0, v2, p1}, LX/2Z0;->AAX(LX/1y4;LX/1PY;)V
...
.method public A02(LX/1QX;)V
    ...
    iget-object v3, v0, LX/3Lo;->A06:LX/2Z0;
    ...
    iget-object v0, v0, LX/3Lo;->A05:LX/1Pf;
    ...
    invoke-direct {v0, p0, v2, v3}, LX/2Ya;-><init>(LX/3Ja;LX/1y4;LX/2ZQ;)V
