...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, LX/02c;->A01:Landroid/widget/ProgressBar;
...
.method public final A00(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, v1, LX/1WG;->A02:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0, p2}, LX/02c;->A00(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {v1, v0}, LX/1WG;->A00(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_3
    invoke-virtual {p0, v2, v0}, LX/02c;->A00(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, LX/02c;->A00:Landroid/graphics/Bitmap;

    if-nez v0, :cond_5

    iput-object v5, p0, LX/02c;->A00:Landroid/graphics/Bitmap;
...
.method public A01(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, LX/02c;->A01:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v2

    sget-object v1, LX/02c;->A02:[I
    ...
    invoke-direct {v8, v2, v0}, LX/03p;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    invoke-virtual {v8, v9}, LX/03p;->A02(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, LX/02c;->A01:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v0, v7}, LX/02c;->A00(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {v8, v7}, LX/03p;->A02(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_3

    iget-object v1, p0, LX/02c;->A01:Landroid/widget/ProgressBar;

    invoke-virtual {p0, v0, v9}, LX/02c;->A00(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object v0, v8, LX/03p;->A02:Landroid/content/res/TypedArray;
