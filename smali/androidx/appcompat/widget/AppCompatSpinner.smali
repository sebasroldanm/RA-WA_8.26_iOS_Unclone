...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A06:LX/02W;

    if-eqz p5, :cond_0

    new-instance v0, LX/01s;

    invoke-direct {v0, p1, p5}, LX/01s;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct {v0, p1, v1}, LX/01s;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v5, p0, v0, p2, p3}, LX/28H;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A04:Landroid/content/Context;

    sget-object v1, LX/013;->A0X:[I

    const/4 v0, 0x0

    new-instance v7, LX/03p;

    invoke-virtual {v6, p2, v1, p3, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v0

    invoke-direct {v7, v6, v0}, LX/03p;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    const/4 v6, 0x3

    const/4 v1, -0x2

    iget-object v0, v7, LX/03p;->A02:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v7, v2}, LX/03p;->A01(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    invoke-virtual {v5, v0}, LX/1VM;->AJ8(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v0, v5, LX/28H;->A02:Ljava/lang/CharSequence;

    iget-object v0, v7, LX/03p;->A02:Landroid/content/res/TypedArray;

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/02m;

    new-instance v0, LX/1VE;

    invoke-direct {v0, p0, p0, v5}, LX/1VE;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/view/View;LX/28H;)V

    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A03:LX/034;
    ...
    :cond_7
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A06:LX/02W;
    ...
    invoke-direct {v1, p0}, LX/1VF;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;)V

    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/02m;
    ...
    invoke-virtual {v1, v0}, LX/1VF;->AJX(Ljava/lang/CharSequence;)V
...
.method public A01()V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/02m;
    ...
    invoke-interface {v2, v1, v0}, LX/02m;->AK2(II)V

    return-void

    :cond_0
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/02m;

    const/4 v0, -0x1

    invoke-interface {v1, v0, v0}, LX/02m;->AK2(II)V
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/02m;

    if-eqz v0, :cond_0

    invoke-interface {v0}, LX/02m;->A5Q()I
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, LX/02m;->A7S()I
...
.method public final getInternalPopup()LX/02m;
    .locals 1
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, LX/02m;->A4A()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, LX/02m;->A5P()Ljava/lang/CharSequence;
...
.method public onDetachedFromWindow()V
    ...
    invoke-interface {v0}, LX/02m;->dismiss()V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-boolean v0, p1, LX/02l;->A00:Z
    ...
    invoke-direct {v0, p0}, LX/02f;-><init>(Landroidx/appcompat/widget/AppCompatSpinner;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v2, v0}, LX/02l;-><init>(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A03:LX/034;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v1, p1, v0}, LX/02g;-><init>(Landroid/widget/SpinnerAdapter;Landroid/content/res/Resources$Theme;)V

    invoke-interface {v2, v1}, LX/02m;->AJ6(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, LX/02m;->AJK(I)V

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->A02:LX/02m;

    invoke-interface {v0, p1}, LX/02m;->AJJ(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, LX/02m;->AJq(I)V
...
.method public setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, LX/02m;->AJ8(Landroid/graphics/drawable/Drawable;)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, LX/02m;->AJX(Ljava/lang/CharSequence;)V
