.class public Lcom/whatsapp/yo/shp;
...
.method static a()V
    ...
    sput-object v0, Lcom/whatsapp/yo/shp;->i:Landroid/content/res/AssetManager;

    sget-object v0, Lcom/whatsapp/yo/shp;->f:Landroid/graphics/Typeface;
    :try_end_0
    ...
    :try_start_1
    sget-object v0, Lcom/whatsapp/yo/shp;->i:Landroid/content/res/AssetManager;
    ...
    sput-object v0, Lcom/whatsapp/yo/shp;->f:Landroid/graphics/Typeface;

    :cond_0
    sget-object v0, Lcom/whatsapp/yo/shp;->g:Landroid/graphics/Typeface;
    :try_end_1
    ...
    sput-object v0, Lcom/whatsapp/yo/shp;->g:Landroid/graphics/Typeface;
    :try_end_2
    ...
    sget-object v1, Lcom/whatsapp/yo/shp;->f:Landroid/graphics/Typeface;

    if-nez v1, :cond_2

    sget-object v1, Lcom/whatsapp/yo/shp;->i:Landroid/content/res/AssetManager;
    ...
    sput-object v1, Lcom/whatsapp/yo/shp;->f:Landroid/graphics/Typeface;
...
.method public static init(Landroid/content/Context;)V
    ...
    sput-object v1, Lcom/whatsapp/yo/shp;->prefs:Landroid/content/SharedPreferences;

    invoke-interface {v1}, Landroid/content/SharedPreferences;->edit()Landroid/content/SharedPreferences$Editor;

    move-result-object v1

    sput-object v1, Lcom/whatsapp/yo/shp;->prefsEditor:Landroid/content/SharedPreferences$Editor;
    ...
    sput-object v1, Lcom/whatsapp/yo/shp;->c:Landroid/content/SharedPreferences$Editor;
    ...
    sput-object v1, Lcom/whatsapp/yo/shp;->a:Landroid/content/SharedPreferences;

    invoke-interface {v1}, Landroid/content/SharedPreferences;->edit()Landroid/content/SharedPreferences$Editor;

    move-result-object v1

    sput-object v1, Lcom/whatsapp/yo/shp;->b:Landroid/content/SharedPreferences$Editor;

    const/4 v1, 0x1

    const-string v2, "V2hhdHNBcHByaXY="

    invoke-static {v2, v1}, Lcom/whatsapp/youbasha/task/utils;->dbsf(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v1

    sput-object v1, Lcom/whatsapp/yo/shp;->privprefsname:Ljava/lang/String;
    ...
    sput-object p0, Lcom/whatsapp/yo/shp;->d:Landroid/content/SharedPreferences;

    invoke-interface {p0}, Landroid/content/SharedPreferences;->edit()Landroid/content/SharedPreferences$Editor;

    move-result-object p0

    sput-object p0, Lcom/whatsapp/yo/shp;->h:Landroid/content/SharedPreferences$Editor;
...
.method public static putGradientColor(Ljava/lang/String;IILandroid/graphics/drawable/GradientDrawable$Orientation;)V
    ...
    sget-object v0, Lcom/whatsapp/yo/shp$1;->a:[I
    ...
    :cond_4
    :goto_0
    invoke-static {p0, p1, p2, v4}, Lcom/whatsapp/yo/shp;->putGradientColor(Ljava/lang/String;III)V
...
.method public static removePrivKey(Ljava/lang/String;)V
    ...
    sget-object v0, Lcom/whatsapp/yo/shp;->h:Landroid/content/SharedPreferences$Editor;
