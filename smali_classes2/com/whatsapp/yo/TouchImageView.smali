...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/whatsapp/yo/TouchImageView$e;,
        Lcom/whatsapp/yo/TouchImageView$State;,
        Lcom/whatsapp/yo/TouchImageView$d;,
        Lcom/whatsapp/yo/TouchImageView$c;,
        Lcom/whatsapp/yo/TouchImageView$b;,
        Lcom/whatsapp/yo/TouchImageView$a;
    }
.end annotation
...
.field private b:Lcom/whatsapp/yo/TouchImageView$b;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, Lcom/whatsapp/yo/TouchImageView;->a(Landroid/content/Context;)V
...
.method static synthetic a(Lcom/whatsapp/yo/TouchImageView;)F
    .locals 0
...
.method private a(FFZ)Landroid/graphics/PointF;
    ...
    invoke-virtual {p0}, Lcom/whatsapp/yo/TouchImageView;->getDrawable()Landroid/graphics/drawable/Drawable;
...
.method static synthetic a(Lcom/whatsapp/yo/TouchImageView;FF)Landroid/graphics/PointF;
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lcom/whatsapp/yo/TouchImageView;->a(FFZ)Landroid/graphics/PointF;
...
.method static synthetic a(Lcom/whatsapp/yo/TouchImageView;Lcom/whatsapp/yo/TouchImageView$b;)Lcom/whatsapp/yo/TouchImageView$b;
    .locals 0

    iput-object p1, p0, Lcom/whatsapp/yo/TouchImageView;->b:Lcom/whatsapp/yo/TouchImageView$b;
...
.method private a()V
    ...
    iget v5, p0, Lcom/whatsapp/yo/TouchImageView;->g:F
    ...
    invoke-direct/range {v2 .. v9}, Lcom/whatsapp/yo/TouchImageView;->a(IFFFIII)V
    ...
    invoke-direct/range {v1 .. v8}, Lcom/whatsapp/yo/TouchImageView;->a(IFFFIII)V
    ...
    invoke-virtual {p0, v0}, Lcom/whatsapp/yo/TouchImageView;->setImageMatrix(Landroid/graphics/Matrix;)V
...
.method private a(Landroid/content/Context;)V
    ...
    new-instance v2, Lcom/whatsapp/yo/TouchImageView$d;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/whatsapp/yo/TouchImageView$d;-><init>(Lcom/whatsapp/yo/TouchImageView;B)V
    ...
    new-instance v2, Lcom/whatsapp/yo/TouchImageView$c;

    invoke-direct {v2, p0, v3}, Lcom/whatsapp/yo/TouchImageView$c;-><init>(Lcom/whatsapp/yo/TouchImageView;B)V
    ...
    iget p1, p0, Lcom/whatsapp/yo/TouchImageView;->k:F
    ...
    iget p1, p0, Lcom/whatsapp/yo/TouchImageView;->j:F
    ...
    invoke-virtual {p0, p1}, Lcom/whatsapp/yo/TouchImageView;->setImageMatrix(Landroid/graphics/Matrix;)V

    sget-object p1, Landroid/widget/ImageView$ScaleType;->MATRIX:Landroid/widget/ImageView$ScaleType;

    invoke-virtual {p0, p1}, Lcom/whatsapp/yo/TouchImageView;->setScaleType(Landroid/widget/ImageView$ScaleType;)V
    ...
    new-instance p1, Lcom/whatsapp/yo/TouchImageView$e;

    invoke-direct {p1, p0, v3}, Lcom/whatsapp/yo/TouchImageView$e;-><init>(Lcom/whatsapp/yo/TouchImageView;B)V

    invoke-virtual {p0, p1}, Lcom/whatsapp/yo/TouchImageView;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    return-void
.end method

.method static synthetic a(Lcom/whatsapp/yo/TouchImageView;FFFZ)V
    .locals 4
    ...
    invoke-direct {p0}, Lcom/whatsapp/yo/TouchImageView;->b()V
...
.method static synthetic a(Lcom/whatsapp/yo/TouchImageView;Ljava/lang/Runnable;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/whatsapp/yo/TouchImageView;->postOnAnimation(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/whatsapp/yo/TouchImageView;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method static synthetic b(Lcom/whatsapp/yo/TouchImageView;)I
    .locals 0
...
.method static synthetic b(Lcom/whatsapp/yo/TouchImageView;FF)Landroid/graphics/PointF;
    .locals 4
    ...
    iget-object p1, p0, Lcom/whatsapp/yo/TouchImageView;->c:[F
...
.method static synthetic c(Lcom/whatsapp/yo/TouchImageView;)I
    .locals 0
...
.method static synthetic d(Lcom/whatsapp/yo/TouchImageView;)Landroid/graphics/Matrix;
    .locals 0
...
.method private d()V
    ...
    iget-boolean v0, p0, Lcom/whatsapp/yo/TouchImageView;->f:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/whatsapp/yo/TouchImageView;->r:Z

    :cond_0
    return-void
.end method

.method static synthetic e(Lcom/whatsapp/yo/TouchImageView;)V
    .locals 0
...
.method static synthetic f(Lcom/whatsapp/yo/TouchImageView;)Landroid/content/Context;
    .locals 0
...
.method static synthetic g(Lcom/whatsapp/yo/TouchImageView;)[F
    .locals 0
...
.method static synthetic j(Lcom/whatsapp/yo/TouchImageView;)Lcom/whatsapp/yo/TouchImageView$State;
    .locals 0
...
.method static synthetic k(Lcom/whatsapp/yo/TouchImageView;)F
    .locals 0
...
.method static synthetic l(Lcom/whatsapp/yo/TouchImageView;)F
    .locals 0
...
.method static synthetic m(Lcom/whatsapp/yo/TouchImageView;)Lcom/whatsapp/yo/TouchImageView$b;
    .locals 0

    iget-object p0, p0, Lcom/whatsapp/yo/TouchImageView;->b:Lcom/whatsapp/yo/TouchImageView$b;

    return-object p0
.end method

.method static synthetic n(Lcom/whatsapp/yo/TouchImageView;)Landroid/view/ScaleGestureDetector;
    .locals 0
...
.method static synthetic o(Lcom/whatsapp/yo/TouchImageView;)Landroid/view/GestureDetector;
    .locals 0
...
.method public fixTrans()V
    ...
    invoke-static {v1, v2, v3}, Lcom/whatsapp/yo/TouchImageView;->b(FFF)F
    ...
    invoke-static {v0, v2, v3}, Lcom/whatsapp/yo/TouchImageView;->b(FFF)F
...
.method public getDrawablePointFromTouchPoint(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-direct {p0, v0, p1, v1}, Lcom/whatsapp/yo/TouchImageView;->a(FFZ)Landroid/graphics/PointF;
...
.method protected onMeasure(II)V
    ...
    invoke-static {p1, v2, v1}, Lcom/whatsapp/yo/TouchImageView;->a(III)I

    move-result p1

    iput p1, p0, Lcom/whatsapp/yo/TouchImageView;->w:I

    invoke-static {p2, v3, v0}, Lcom/whatsapp/yo/TouchImageView;->a(III)I

    move-result p1

    iput p1, p0, Lcom/whatsapp/yo/TouchImageView;->v:I

    iget p1, p0, Lcom/whatsapp/yo/TouchImageView;->w:I

    iget p2, p0, Lcom/whatsapp/yo/TouchImageView;->v:I

    invoke-virtual {p0, p1, p2}, Lcom/whatsapp/yo/TouchImageView;->setMeasuredDimension(II)V

    invoke-direct {p0}, Lcom/whatsapp/yo/TouchImageView;->a()V
    ...
    invoke-virtual {p0, p1, p1}, Lcom/whatsapp/yo/TouchImageView;->setMeasuredDimension(II)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget v1, p0, Lcom/whatsapp/yo/TouchImageView;->g:F

    const-string v2, "matchViewHeight"

    invoke-virtual {v0, v2, v1}, Landroid/os/Bundle;->putFloat(Ljava/lang/String;F)V

    iget v1, p0, Lcom/whatsapp/yo/TouchImageView;->h:F
...
.method public setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    invoke-direct {p0}, Lcom/whatsapp/yo/TouchImageView;->d()V

    invoke-direct {p0}, Lcom/whatsapp/yo/TouchImageView;->c()V
