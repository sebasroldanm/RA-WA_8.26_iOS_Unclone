...
.method public checkForUpdates(Landroid/view/View;)V
    ...
    new-instance p1, Lcom/whatsapp/yo/chup;

    const/4 v1, 0x1

    invoke-direct {p1, v1, p0}, Lcom/whatsapp/yo/chup;-><init>(ZLandroid/app/Activity;)V

    sget-object v1, Landroid/os/AsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;

    new-array v0, v0, [Ljava/lang/Void;

    invoke-virtual {p1, v1, v0}, Lcom/whatsapp/yo/chup;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Lcom/whatsapp/youbasha/ui/YoSettings/Updates;->setContentView(I)V
